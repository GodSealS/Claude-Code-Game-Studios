...
- Only modify files relevant to 3D rendering in the project (under `assets/` directory, e.g. `assets/Scripts/3D/`, `assets/Scripts/Rendering/`)
...
## File Scope
- Game project's 3D rendering files under `assets/` directory
