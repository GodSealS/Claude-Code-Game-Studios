...
| **D4 — GLM-5.1 model tier** | Agent is assigned GLM-5.1 model per coordination-rules.md |
...
| **L3 — Kimi-K2.6 model tier** | Agent is assigned Kimi-K2.6 model (default) per coordination-rules.md |
