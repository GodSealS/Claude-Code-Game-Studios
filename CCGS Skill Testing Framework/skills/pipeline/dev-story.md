...
- `.codebuddy/docs/technical-preferences.md` has engine and language configured
...
- Engine routing logic (Godot vs Unity vs Unreal vs Cocos Creator) is not tested per engine —
