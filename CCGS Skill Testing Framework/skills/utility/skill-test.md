...
- **audit**: Produces a coverage table of all skills in `.codebuddy/skills/` and
  all agents in `.codebuddy/agents/`, showing which have spec files and which do not.
...
**Fixture:**
- `.codebuddy/skills/brainstorm/SKILL.md` exists and is well-formed:
...
**Expected behavior:**
1. Skill reads `.codebuddy/skills/brainstorm/SKILL.md`
...
**Fixture:**
- `.codebuddy/skills/some-skill/SKILL.md` has `Write` in `allowed-tools` frontmatter
...
- `.codebuddy/skills/gate-check/SKILL.md` exists
...
**Fixture:**
- `.codebuddy/skills/` contains 72+ skill directories
- `.codebuddy/agents/` contains 49+ agent files
- `tests/skills/` contains spec files for a subset of skills

**Input:** `/skill-test audit`

**Expected behavior:**
1. Skill enumerates all skills in `.codebuddy/skills/` and all agents in `.codebuddy/agents/`
...
- `.codebuddy/skills/gate-check/SKILL.md` is a gate skill
