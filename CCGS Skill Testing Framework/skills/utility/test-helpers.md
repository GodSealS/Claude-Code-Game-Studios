...
- Cocos Creator TypeScript helper generation (using Jest assertions and cc module
  imports) follows the same logic as Case 1 with language-appropriate output.
