...
**Fixture:**
- `.codebuddy/skills/some-skill/SKILL.md` has 2 static failures:
...
4. Skill asks "May I write improvements to `.codebuddy/skills/some-skill/SKILL.md`?"
...
**Fixture:**
- `.codebuddy/skills/some-skill/SKILL.md` has 1 static failure (missing handoff)
...
**Fixture:**
- `.codebuddy/skills/gate-check/SKILL.md` is a gate skill with 1 static failure
...
4. "May I write improvements to `.codebuddy/skills/gate-check/SKILL.md`?"
...
**Fixture:**
- `.codebuddy/skills/brainstorm/SKILL.md` has no static failures
