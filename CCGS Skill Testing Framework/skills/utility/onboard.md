...
team member. It reads CODEBUDDY.md, `technical-preferences.md`, the active sprint
...
- No sprint files
- No CODEBUDDY.md overrides beyond defaults
...
### Case 3: No CODEBUDDY.md Found — Error with remediation

**Fixture:**
- `CODEBUDDY.md` file does not exist (deleted or never created)
- All other files may or may not exist

**Input:** `/onboard`

**Expected behavior:**
1. Skill attempts to read CODEBUDDY.md and fails
2. Skill outputs an error: "CODEBUDDY.md not found — cannot generate onboarding summary"
3. Skill provides remediation: "Run `/start` to initialize the project configuration"
4. No partial summary is generated

**Assertions:**
- [ ] Error message clearly identifies the missing file as CODEBUDDY.md
