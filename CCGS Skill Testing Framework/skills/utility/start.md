...
initial directory structure. It creates stub configuration files (CODEBUDDY.md,
...
**Fixture:**
- Empty repository: no CODEBUDDY.md overrides, no `production/stage.txt`, no
...
3. Skill presents 4 engine options: Godot 4, Unity, Unreal Engine 5, Cocos Creator
...
7. Skill asks "May I write CODEBUDDY.md stub?" and writes it on approval
...
2. Skill writes initial stubs (directory structure, CODEBUDDY.md) after approval
...
- [ ] Asks "May I write" separately for directory structure and for CODEBUDDY.md stub
