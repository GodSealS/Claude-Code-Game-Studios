...
- [ ] Phase 2 includes spawning the primary engine specialist (read from `.codebuddy/docs/technical-preferences.md`)
...
- Engine is configured in `.codebuddy/docs/technical-preferences.md` (Engine Specialists section filled)
...
**Fixture:**
- `.codebuddy/docs/technical-preferences.md` has Engine Specialists section populated (e.g., Primary: godot-specialist)
...
2. Skill reads `.codebuddy/docs/technical-preferences.md` Engine Specialists section to identify the primary engine specialist agent type
...
**Assertions:**
- [ ] Engine specialist agent type is read from `.codebuddy/docs/technical-preferences.md` — not hardcoded
