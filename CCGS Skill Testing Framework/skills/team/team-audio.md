...
- Engine is configured in `.codebuddy/docs/technical-preferences.md`
...
**Fixture:**
- Engine is NOT configured in `.codebuddy/docs/technical-preferences.md` (shows `[TO BE CONFIGURED]`)
- GDD for the target feature exists
...
**Expected behavior:**
1. Context gathering: orchestrator reads `.codebuddy/docs/technical-preferences.md` and detects no engine is configured
