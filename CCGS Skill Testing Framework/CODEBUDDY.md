...
| File | Purpose                                                                                                                                                             |
|------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `catalog.yaml` | Master registry for all 81 skills and 58 agents. Contains category, spec path, and last-test tracking fields. Always read this first when running any test command. |
...
cocos       → cocos-specialist, cocos_2d-expert, cocos_3d-expert, cocos_gfx-expert,
              cocos_core-expert, cocos_physics-expert, cocos_physics-2d-expert,
              cocos_animation-expert, cocos_rendering-expert
