...
- **Domain**: CI/CD (UAT/UBT), version control workflow, build matrix optimization.
...
**Expected behavior**:
- Recommends trunk-based development per project conventions (CODEBUDDY.md / coordination-rules.md specify Git with trunk-based development)
...
- Does NOT override the project convention without flagging that doing so requires updating CODEBUDDY.md
