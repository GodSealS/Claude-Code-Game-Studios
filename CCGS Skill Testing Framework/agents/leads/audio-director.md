...
**Gate IDs handled:** AD-VISUAL (audio aspect of the phase gate; may be referenced as part of AU-PHASE-GATE in the audio dimension).
...
**Assertions:**
- [ ] Verdict is exactly one of APPROVED / NEEDS REVISION / CONCERNS / REJECT
