...
Read the `Engine Specialists` section of `.codebuddy/docs/technical-preferences.md`
...
| Cocos Creator | `cocos-specialist`, `cocos_2d-expert`, `cocos_3d-expert`, `cocos_core-expert`, `cocos_animation-expert`, `cocos_rendering-expert`, `cocos_rendering-expert`, `cocos_physics-expert`, `cocos_physics-2d-expert` |
...
5. **Engine preferences**: `.codebuddy/docs/technical-preferences.md` — read naming conventions and performance budgets
