...
Read `CODEBUDDY.md` and `.claude/docs/technical-preferences.md` for the engine and
language in use.
...
**Lighter alternative — Love2D (Lua):** If the project engine (Godot, Unity, Unreal,Cocos Creator)
