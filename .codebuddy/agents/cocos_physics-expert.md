...
description: Cocos Creator 3D physics engine expert. Automatically invoked when users need to add rigid bodies and colliders, implement character collision detection, configure physics world parameters, use raycast, create joint constraints, or handle physics collision events. 
