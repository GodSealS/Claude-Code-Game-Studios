...
- `UseSkill("cocos_editor")` — Editor operations via Cocos MCP Server: scene/node/component management, prefab creation, asset management, UI layout, VFX, character creation, project build
...
| Scene/node/component ops, prefabs, assets, VFX, build — editor MCP | `UseSkill("cocos_editor")` |
