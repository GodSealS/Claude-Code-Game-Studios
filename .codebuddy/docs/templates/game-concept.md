...
| ---- | ---- |
| **Recommended Engine** | [Godot / Unity / Unreal / Cocos Creator and why — consider scope, team expertise, platform targets] |
...
- [ ] Fill in CODEBUDDY.md technology stack based on engine choice (`/setup-engine`)
