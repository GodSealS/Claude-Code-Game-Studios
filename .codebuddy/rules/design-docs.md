...
- Design documents MUST be written incrementally: create skeleton first, then fill
  ...
  > **中文翻译**：设计文档必须增量编写：先创建骨架，然后逐个填充每个章节，每个章节之间需要用户批准。将每个已批准的章节立即写入文件，以持久化决策并管理上下文
