...
> **中文翻译**：`assets/shaders/` 中的所有着色器文件必须遵循这些标准，以保持视觉质量、性能和跨平台兼容性。

## Naming Conventions / 命名约定

- File naming: `[type]_[category]_[name].[ext]`
  > **中文翻译**：文件命名：`[类型]_[类别]_[名称].[扩展名]`
